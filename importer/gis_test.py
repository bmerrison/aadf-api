...
# British National Grid to Latitude and Longitude
# Thanks: http://www.hannahfry.co.uk/blog/2012/02/01/converting-british-national-grid-to-latitude-and-longitude-ii
...
def get_east_devon():
    sf = shapefile.Reader('Wards_December_2016_Full_Clipped_Boundaries_in_Great_Britain')
    field_names = [f[0] for f in sf.fields[1:]]
    records = [{f: v for f, v in zip(field_names, record)} for record in sf.records()]
    easting, northing = 265410, 51910
